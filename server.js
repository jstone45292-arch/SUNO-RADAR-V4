...
async function getFriendYouTube(
  friend
) {
  if (
    !friend ||
...
app.listen(
  ...
  () => {
    ...
    console.log(
      `Creator Radar V6.0 Server running on ${PORT}`
    );
